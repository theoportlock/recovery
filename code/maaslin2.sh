...
Maaslin2.R results/filtered/wolkes.tsv results/timemeta_MAM.tsv results/maaslin/wolkes -f "timepoint,Recovery,Feed" -r "subjectID" -d "Recovery,No recovery;Feed,Local RUSF (A)"
